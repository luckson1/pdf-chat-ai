...
export const Icons = {
  ...
  pdf: (props: LucideProps) => (
    <svg {...props} viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
      <path
        d="m24.1 2.072 5.564 5.8v22.056h-20.785v.072h20.856v-22.055z"
        fill="#909090"
      />
      <path
        d="m24.031 2h-15.223v27.928h20.856v-22.055l-5.634-5.873"
        fill="#f4f4f4"
      />
      <path d="m8.655 3.5h-6.39v6.827h20.1v-6.827z" fill="#7a7b7c" />
      <path d="m22.472 10.211h-20.077v-6.832h20.077z" fill="#dd2025" />
      <g fill="#464648">
      ...
      <path
        ...
        fill="#dd2025"
      />
      <path d="m23.954 2.077v5.873h5.633z" fill="#909090" />
      <path d="m24.031 2v5.873h5.633z" fill="#f4f4f4" />
      <path
        d="m8.975 4.457h-.03-.207-1.07v4.8h1.032v-1.618l.228.013a2.042 2.042 0 0 0 .647-.117 1.428 1.428 0 0 0 .493-.291 1.224 1.224 0 0 0 .332-.454 2.13 2.13 0 0 0 .105-.908 2.237 2.237 0 0 0 -.114-.644 1.173 1.173 0 0 0 -.687-.65 2.149 2.149 0 0 0 -.411-.105 2.232 2.232 0 0 0 -.319-.026m-.189 2.294h-.089v-1.48h.194a.57.57 0 0 1 .459.181.92.92 0 0 1 .183.558c0 .246 0 .469-.222.626a.942.942 0 0 1 -.524.114"
        fill="#fff"
      />
      <path
        d="m12.456 4.444c-.111 0-.219.008-.295.011l-.235.006h-.78v4.8h.918a2.677 2.677 0 0 0 1.028-.175 1.71 1.71 0 0 0 .68-.491 1.939 1.939 0 0 0 .373-.749 3.728 3.728 0 0 0 .114-.949 4.416 4.416 0 0 0 -.087-1.127 1.777 1.777 0 0 0 -.4-.733 1.63 1.63 0 0 0 -.535-.4 2.413 2.413 0 0 0 -.549-.178 1.282 1.282 0 0 0 -.228-.017m-.182 3.937h-.1v-3.064h.013a1.062 1.062 0 0 1 .6.107 1.2 1.2 0 0 1 .324.4 1.3 1.3 0 0 1 .142.526c.009.22 0 .4 0 .549a2.926 2.926 0 0 1 -.033.513 1.756 1.756 0 0 1 -.169.5 1.13 1.13 0 0 1 -.363.36.673.673 0 0 1 -.416.106"
        fill="#fff"
      />
      <path
        d="m17.353 4.461h-2.43v4.8h1.028v-1.904h1.3v-.892h-1.3v-1.112h1.4v-.892"
        fill="#fff"
      />
    </svg>
  ),
  ...
  teams: (props: LucideProps) => (
    ...
    >
      <g>
        <path
          fill="#464eb8"
          d="M84.025,35.881c5.797,0,10.513-4.729,10.513-10.54c-0.577-13.983-20.45-13.979-21.026,0
    C73.512,31.152,78.229,35.881,84.025,35.881z"
        ></path>
        <path
          fill="#464eb8"
          d="M90.958,38.71H72.193h-0.036c-0.005,0-0.003,0-0.009,0c-1.123,0-15.805,0-20.538,0v-3.68
    ...
    >
      <defs>
        <linearGradient id="a" x1="103.648%" x2="3.848%" y1="100%" y2="0%">
          <stop offset="0%" stopColor="#0D58BF"></stop>
          <stop offset="100%" stopColor="#0A3070"></stop>
        </linearGradient>
        <linearGradient id="e" x1="0%" x2="105.047%" y1="58.792%" y2="77.978%">
          <stop offset="0%" stopColor="#007FC0"></stop>
          <stop offset="100%" stopColor="#00E6FF"></stop>
        </linearGradient>
        <linearGradient
          id="i"
          x1="4.973%"
          ...
          y2="97.733%"
        >
          <stop offset="0%" stopColor="#0094F2"></stop>
          <stop offset="100%" stopColor="#00C8FF"></stop>
        </linearGradient>
        <linearGradient
          id="l"
          x1="6.798%"
          ...
          y2="57.988%"
        >
          <stop offset="0%" stopColor="#004FA7"></stop>
          <stop offset="100%" stopColor="#006DD9"></stop>
        </linearGradient>
        <pattern
          id="c"
          width="512"
