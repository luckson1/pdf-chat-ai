...
const DocViewer: FC<DocViewerProps> = (props) => {
  ...
  return (
    ...
    <AppProvider    {...props}>
        <Card {...props} className="w-full h-[85vh]  justify-center items-center flex flex-col overflow-y-hidden overflow-x-auto  scrollbar-track-primary, scrollbar-thumb-primary">
